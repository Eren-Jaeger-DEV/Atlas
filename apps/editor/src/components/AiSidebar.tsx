        ...
        <div style={{
          ...
          <button
            style={{
              ...
              border: "none",
              color: activeView === "composer-diff" ? "#f4f4f5" : "#52525b",
              cursor: "pointer",
              padding: "5px 6px",
              borderRadius: "5px",
              display: "flex",
              ...
              background: activeView === "composer-diff" ? "rgba(255,255,255,0.07)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor: "transparent",
              border: "none",
              color: activeView === "tasks" ? "#f4f4f5" : "#52525b",
              cursor: "pointer",
              padding: "5px 6px",
              borderRadius: "5px",
              display: "flex",
              ...
              justifyContent: "center",
              transition: "color 0.15s ease, background 0.15s ease",
              background: activeView === "tasks" ? "rgba(255,255,255,0.07)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor: "transparent",
              border: "none",
              color: activeView === "artifacts" ? "#f4f4f5" : "#52525b",
              cursor: "pointer",
              padding: "5px 6px",
              borderRadius: "5px",
              display: "flex",
              ...
              justifyContent: "center",
              transition: "color 0.15s ease, background 0.15s ease",
              background: activeView === "artifacts" ? "rgba(255,255,255,0.07)" : "transparent"
            }}
          ...
          <button
            style={{
              backgroundColor: "transparent",
              border: "none",
              color: activeView === "web-preview" ? "#f4f4f5" : "#52525b",
              cursor: "pointer",
              padding: "5px 6px",
              borderRadius: "5px",
              display: "flex",
              ...
              justifyContent: "center",
              transition: "color 0.15s ease, background 0.15s ease",
              background: activeView === "web-preview" ? "rgba(255,255,255,0.07)" : "transparent"
            }}
